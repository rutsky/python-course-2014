...
.. TODO: в заголовке документа должен быть Python
   TODO: Рассказать о популярности языка (рейтинг TIOBE и т.п.)
   TODO: Рассказать об аргументах функции print, чтобы было понятно как
   отменить перевод строк или вывод пробелов.
   TODO: Подробней рассказать о распаковки в присваивании
   TODO: При рассказе о цикле for рассказать о распаковки аргументов.
   TODO: При рассказе о словарях сказать, что порядок не определён.

...
* Примерами нативного кода являются скомилированные из C/C++ библиотеки (DLL) и выполняемые файлы (exe)
...
* Вызов и передача примитивых типов, структор, указателей, блоков памяти внутрь функций (а также получение результата)
